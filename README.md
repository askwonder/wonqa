...
- `configurationPath` [string] **required unless `nginx.servers`**: The path to a local file containing your nginx configuration. For a sample configuration, see this [example](/askwonder/wonqa/blob/master/examples/nginx.conf)
